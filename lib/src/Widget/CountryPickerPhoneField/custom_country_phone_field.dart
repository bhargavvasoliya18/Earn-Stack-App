...
class IntlPhoneField extends StatefulWidget {
  ...
  IntlPhoneField({
    ...
    this.invalidNumberMessage = 'Please enter valid phone number',
    this.cursorHeight,
...
class _IntlPhoneFieldState extends State<IntlPhoneField> {
  ...
  void initState() {
    ...
    inputFormatters.insert(inputFormatters.length,LengthLimitingTextInputFormatter(_selectedCountry.maxLength));
  }
      ...
      builder: (context) => StatefulBuilder(
        builder: (ctx, setState) => CountryPickerDialog(
          ...
          onCountryChanged: (Country country) {
            ...
            inputFormatters.removeAt(inputFormatters.length-1);
            inputFormatters.insert(inputFormatters.length,LengthLimitingTextInputFormatter(_selectedCountry.maxLength));
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: widget.decoration.copyWith(
        ...
        prefixIconConstraints: const BoxConstraints(minHeight: 10, minWidth: 10),
