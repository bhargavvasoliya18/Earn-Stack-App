          ...
          children: <Widget>[
            Padding(
              ...
              child: TextField(
                ...
                style: TextStyleTheme.customTextStyle(Colors.black, 16, FontWeight.w500),
                decoration: widget.style?.searchFieldInputDecoration ??
                    InputDecoration(
                        suffixIcon: Icon(Icons.search),
                        labelText: widget.searchText,
                        labelStyle: TextStyle(fontFamily: appFontFamily, color: Colors.red),
                    ),
                onChanged: (value) {
                    ...
                    ListTile(
                      ...
                      title: Text(
                        ...
                        style: widget.style?.countryNameStyle ??
                            TextStyle(fontFamily:appFontFamily,fontWeight: FontWeight.w700),
                      ),
                      trailing: Text(
