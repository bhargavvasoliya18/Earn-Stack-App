      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("8 coin received", style: TextStyleTheme.customTextStyle(AppColors.black, 20, FontWeight.w500),),
            paddingTop(10),
            Container(
              decoration: BoxDecoration(
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            Text("08", style: TextStyleTheme.customTextStyle(AppColors.green, 32, FontWeight.bold),),
                          ],
                        ),
                        paddingLeft(10),
                        ...
                        Column(
                          children: [
                            ...
                            Text("02", style: TextStyleTheme.customTextStyle(AppColors.red, 32, FontWeight.bold),),
                          ],
                        )
                      ],
                    ),
                    Text("Out of 10", style: TextStyleTheme.customTextStyle(Color(0xff999999), 14, FontWeight.w400),)
                  ],
                ),
              ),
            ),
