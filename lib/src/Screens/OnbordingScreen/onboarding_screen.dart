...
OnBoardingScreen() => ChangeNotifierProvider<OnBoardingNotifier>(
      create: (_) => OnBoardingNotifier(),
      child: Builder(builder: (context) => OnBoardingScreenProvider(context: context)),
    );
                          ...
                          return Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Text(
                                  model.title ?? "",
                                  style: TextStyleTheme.customTextStyle(AppColors.black, 20, FontWeight.w800),
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                    ...
                                    child: Text(
                                      model.subTitle ?? "",
                                      style: TextStyleTheme.customTextStyle(AppColors.lightGrey, 14, FontWeight.w500),
                                      textAlign: TextAlign.center,
                                    )),
                              ),
                              paddingTop(08),
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          state.currentPage != 0
                              ? GestureDetector(
                                  onTap: () {
                                    state.navigateBackScreen();
                                  },
                                  child: Text(
                                    OnBoardingString.back,
                              ...
                              itemBuilder: (context, index) {
                                return Center(
                                  child: AnimatedContainer(
                                    ...
                                    decoration: state.currentPage == index
                                        ? const BoxDecoration(
