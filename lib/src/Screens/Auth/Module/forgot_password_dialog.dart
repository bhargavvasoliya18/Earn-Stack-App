        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              paddingTop(25),
              commonButton(LoginString.reset, width: 150, onTap: (){Navigator.pop(context); enterOtpDialog(context);}),
              paddingTop(10),
              Row(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                paddingTop(25),
                commonButton(LoginString.submit, width: 150, onTap: (){Navigator.pop(context); /*enterNewPasswordDialog(context);*/}),
                paddingTop(10),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
...
enterNewPasswordDialog(context){
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                paddingTop(15),
                paddingTop(15),
                customTextField(forgotPasswordController, "Password", "******", suffixIcon: state.isVisibleForgotPassword ? AppImages.closeIcon : AppImages.openIcon, suffixIconTap: (){setState((){
